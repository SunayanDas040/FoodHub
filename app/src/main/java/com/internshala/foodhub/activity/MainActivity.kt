...
class MainActivity : AppCompatActivity() {
    ...
    lateinit var txtUserPhoneNumber: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        txtUserPhoneNumber = header.findViewById(R.id.txtUserPhoneNumber)

        setUpToolbar()

        openHome()

        txtUserName.text = profilePreferences.getString("name",null)
        txtUserPhoneNumber.text = profilePreferences.getString("mobile_number", null)
